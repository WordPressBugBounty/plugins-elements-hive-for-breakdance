(function(u){typeof define=="function"&&define.amd?define(u):u()})(function(){"use strict";const u=`
  ...
  <div class="eh-actions-bar">
    ...
    <div class="eh-actions-bar__btn-wrapper">
      <button type="button" class="v-btn v-btn--icon v-btn--round theme--dark v-size--small eh-action-bar__btn eh-colors-popover-toggle">
        <span class="v-btn__content">
          <div class="breakdance-icon" style="width: 14px; height: 14px;">
            ${f}
          </div>
    ...
    <div class="eh-actions-bar__btn-wrapper">
      <button type="button" class="v-btn v-btn--icon v-btn--round theme--dark v-size--small eh-action-bar__btn eh-docking-popover-toggle">
        <span class="v-btn__content">
          <div class="breakdance-icon" style="width: 14px; height: 14px;">
            ${w}
          </div>
  ...
  /* 
   ** No longer needed. Already enabled in the new code mirror **
  ...
  */
  ...
  /* 
   ** Blocks the editor from scrolling in the new code mirror version **
  ...
  */
  ...
  /* 
   ** Align with the format button action added by BD for code mirror 6 **
